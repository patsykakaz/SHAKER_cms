...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ville_BarDuMonde.richtextpage_ptr'
        db.delete_column(u'SHAKER_ville_bardumonde', u'richtextpage_ptr_id')

        # Adding field 'Ville_BarDuMonde.page_ptr'
        db.add_column(u'SHAKER_ville_bardumonde', u'page_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['pages.Page'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Ville_BarDuMonde.richtextpage_ptr'
        db.add_column(u'SHAKER_ville_bardumonde', u'richtextpage_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['pages.RichTextPage'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'Ville_BarDuMonde.page_ptr'
        db.delete_column(u'SHAKER_ville_bardumonde', u'page_ptr_id')
